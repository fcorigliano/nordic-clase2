const { getStrategyByName } = require('frontend-lazy/helpers');
...
function lazy(options = {}) {
  return Object.assign((context, webpackConfig) => {
    context.strategy = options.splitChunks
      ? getStrategyByName(options.splitChunks) : false;
    return {
      ...addPlugins([new LoadablePlugin(options.plugin || {})])(),
      ...babel({
        plugins: '@loadable/babel-plugin',
      })(context),
      ...(context.strategy ? context.strategy(webpackConfig) : {}),
    };
  }, { post: postConfig });
}
