...
describe('Utils links', () => {
  ...
  describe('generateLink', () => {
    it('generates a specific user link with no side effects', () => {
      ...
      const generatedUserLink = Module.generateLink({ url, link, currentUrl });
    ...
    it('generates a specific user link with no side effects and icon', () => {
      const url = { name: 'Inicio', link: 'https://home.mercadolibre.com.ar' };
      const link = 'home';
      const currentUrl = 'https://www.mercadolibre.com.ar/';

      const generatedUserLink = Module.generateLink({ url, link, currentUrl, icons: { home: 'nav-home-icon' } });
    ...
    it('generates a specific user link with side effects', () => {
      ...
      const currentUrl = 'https://www.mercadolibre.com.ar/';
      const enhancement = {
        enhance: (urlLink, props) => Object.assign({}, urlLink, { osName: props.device.osName }),
      };
