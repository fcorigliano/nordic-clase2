...
describe('Mercado Shops Navigation', () => {
  it('should render the received raw elements', () => {
    const renderer = new ShallowRenderer();
    const component = <Navigation {...navigationProps}>Mshops children</Navigation>;
  ...
  it('should render nothing', () => {
    const renderer = new ShallowRenderer();
    const component = <Navigation {...navigationProps} type="hidden">Mshops children</Navigation>;
    const renderedComponent = renderer.render(component);
    expect(renderedComponent).toMatchSnapshot();
  });

  it('should render nothing if no shopModel', () => {
    const renderer = new ShallowRenderer();
    const navigationPropsWithoutShopModel = {
      ...navigationProps,
      shopModel: null,
    };
    const component = <Navigation {...navigationPropsWithoutShopModel} type="hidden">Mshops children</Navigation>;
    const renderedComponent = renderer.render(component);
    expect(renderedComponent).toMatchSnapshot();
  });
});
