...
const ShallowRenderer = require('react-test-renderer/shallow'); //eslint-disable-line
...
const baseProps = {
  raw: appearance.getComponentProperty('Header', 'raw'),
  widgets: appearance.getComponentProperty('Header', 'widgets'),
};

describe('Mercado Shops Header', () => {
  it('should render the received rawHeader', () => {
    const renderer = new ShallowRenderer();
    const component = <Header {...baseProps} />;
  ...
  it('should render nothing', () => {
    const renderer = new ShallowRenderer();
    const component = <Header {...baseProps} hide />;
    const renderedComponent = renderer.render(component);
    expect(renderedComponent).toMatchSnapshot();
  });
});
