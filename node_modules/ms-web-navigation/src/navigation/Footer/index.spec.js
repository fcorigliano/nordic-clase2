...
const baseProps = {
  raw: appearance.getComponentProperty('Footer', 'raw'),
  widgets: appearance.getComponentProperty('Footer', 'widgets'),
};

describe('Mercado Shops Navigation', () => {
  it('should render the received rawFooter', () => {
    const renderer = new ShallowRenderer();
    const component = <Footer {...baseProps} />;
  ...
  it('should render nothing', () => {
    const renderer = new ShallowRenderer();
    const component = <Footer {...baseProps} hide />;
    const renderedComponent = renderer.render(component);
    expect(renderedComponent).toMatchSnapshot();
  });
});
