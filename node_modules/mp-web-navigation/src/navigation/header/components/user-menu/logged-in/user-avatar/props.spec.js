const userAvatarProps = require('./props');
...
jest.mock('ml-navigation-config', () => ({ getValue: () => mockedConfig }));

describe('Mercado Pago Navigation', () => {
  describe('UserAvatar props', () => {
    it('returns props needed for the userAvatar Component', () => {
