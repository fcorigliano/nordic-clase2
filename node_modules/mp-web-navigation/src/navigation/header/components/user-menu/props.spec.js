...
describe('Mercado Pago Navigation', () => {
  describe('User Menu props', () => {
    it('returns props needed for the User Menu Component', () => {
      const props = userMenuProps({ ...baseProps, user: null });

      expect(props.isLoggedIn).toBeDefined();
      expect(props.guestMenu).toBeDefined();
      expect(props.loggedInMenu).toEqual({});
    });

    it('returns props needed for the User Menu Component when the user is logged In', () => {
      const props = userMenuProps(baseProps);

      expect(props.isLoggedIn).toBeDefined();
      expect(props.loggedInMenu).toBeDefined();
      expect(props.guestMenu).toEqual({});
    });
  });
});
