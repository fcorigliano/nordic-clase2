const navigationProps = require('./props');
...
describe('Mercado Pago Navigation', () => {
  describe('Navigation props', () => {
    it('returns props needed for the Navigation Component with user logged', () => {
      const props = navigationProps(baseProps);
    ...
    it('returns props needed for the Navigation Component with guest logged', () => {
      const props = navigationProps({ ...baseProps, user: null });

      expect(Array.isArray(props.links)).toBe(true);
      expect(props.isLoggedIn).toBeFalsy();
      expect(props.userInfo).toBeFalsy();
      expect(props.deviceType).toBeDefined();
    });
  });
});
