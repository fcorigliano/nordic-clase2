...
describe('Mercado Pago Navigation', () => {
  describe('Footer Navigation props', () => {
    it('returns props needed for the Footer Navigation Component', () => {
      const props = navigationProps(baseProps);

      expect(props.navPerformanceSection.links).toBeDefined();
      expect(Array.isArray(props.navPerformanceSection.links)).toBe(true);
    });

    it('returns empty props since type is hidden', () => {
