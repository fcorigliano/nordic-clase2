const footerReclamationBookProps = require('./props');
...
describe('Mercado Pago Navigation', () => {
  describe('Footer Navigation props', () => {
    it('returns props needed for the Footer ReclamationBook Component', () => {
      const props = footerReclamationBookProps(baseProps);

      expect(props).toBeDefined();
    });

    it('returns empty props since type is hidden', () => {
      const props = footerReclamationBookProps({
        ...baseProps,
        type: 'hidden',
      });
