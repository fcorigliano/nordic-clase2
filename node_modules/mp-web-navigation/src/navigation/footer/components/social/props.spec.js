const footerNavigationProps = require('./props');
...
describe('Mercado Pago Navigation', () => {
  describe('Social Footer Navigation props', () => {
    it('returns props needed for the Social Footer Navigation Component', () => {
      const props = footerNavigationProps(baseProps);
    ...
    it('returns empty props since type is hidden', () => {
      const props = footerNavigationProps({
        ...baseProps,
        type: 'hidden',
      });
