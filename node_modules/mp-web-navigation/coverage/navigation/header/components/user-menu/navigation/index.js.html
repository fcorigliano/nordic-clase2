...
<head>
    <title>Code coverage report for navigation/header/components/user-menu/navigation/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">navigation/header/components/user-menu/navigation</a> index.js</h1>
        <div class='clearfix'>
  ...
  return (
    &lt;&gt;
      ...
      &gt;
        ...
        {deviceType !== DESKTOP &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >&lt;LandingNavigationMobile {...landingNavigation} /&gt;}</span>
        {
          links.map(item =&gt; (
            &lt;Link
              {...item}
