const snackbarProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('Snackbar Props', () => {
    it('returns the necessary props for the snackbar widget', () => {
      const props = snackbarProps(baseProps);

      expect(props.version).toEqual(baseProps.navigationFeatures.snackbarVersion);
