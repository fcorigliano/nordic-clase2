const categoriesProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('Categories Props', () => {
    it('returns the necessary props for the categories widget', () => {
      const props = categoriesProps(baseProps);

      expect(props.version).toEqual(baseProps.navigationFeatures.categoriesVersion);
      expect(props.baseUrl).toEqual(baseProps.cdn.link);
      expect(props.domain).toEqual(baseProps.urls.baseDomain.link);
    });
  });
});
