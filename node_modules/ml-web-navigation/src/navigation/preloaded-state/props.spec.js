...
const preloadedStateProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('Preloaded state props', () => {
    it('returns props needed for the Preloaded state', () => {
      const props = preloadedStateProps(baseProps);

      expect(props.application).toEqual('ml-web-navigation');
      expect(props.os).toEqual('android');
    });
  });
});
