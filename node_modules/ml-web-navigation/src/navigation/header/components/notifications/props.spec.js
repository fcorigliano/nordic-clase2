const notificationsProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('Notifications props', () => {
    it('returns props for notifications', () => {
      const props = notificationsProps(baseProps);

      expect(props.count).toEqual(baseProps.notificationsInfo.count);
    });
  });
});
