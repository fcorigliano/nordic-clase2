const exhibitorProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('Exhibitor props', () => {
    it('returns props when exhibitor exists', () => {
      const props = exhibitorProps(baseProps);

      expect(props.link).toEqual(baseProps.exhibitorInfo.permalink);
      expect(props.picture).toBeDefined();
      expect(props.title).toBeDefined();
    });

    it('returns props when exhibitor does not exist', () => {
      const exProps = { ...baseProps, exhibitorInfo: null };
      const props = exhibitorProps(exProps);

      expect(props.link).not.toBeDefined();
      expect(props.picture).not.toBeDefined();
