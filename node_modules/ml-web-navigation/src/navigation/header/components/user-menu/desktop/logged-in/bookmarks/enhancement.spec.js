...
const bookmarksEnhancement = require('./enhancement');
...
describe('Mercado Libre Navigation', () => {
  describe('Bookmarks Enhancement', () => {
    it('returns a valid set of props for bookmarks link', () => {
      const url = {
        link: {
          href: 'https://www.mercadolibre.com.ar',
          className: 'option-bookmarks',
        },
        name: 'Favoritos',
      };

      const urlWithInjectedProps = bookmarksEnhancement.enhance(url, baseProps);

      expect(urlWithInjectedProps.link.href).toEqual(url.link.href);
      expect(urlWithInjectedProps.link.className).toEqual('option-bookmarks bookmarks-widget');
