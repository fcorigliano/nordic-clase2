...
describe('Mercado Libre Navigation', () => {
  describe('User Menu props', () => {
    it('returns props when layout type is plus', () => {
    ...
    it('returns props when layout type is lite', () => {
      const props = guestUserMenuProps({ ...baseProps, type: 'pluslite' });
    ...
    it('returns props when layout type is clean', () => {
      const props = guestUserMenuProps({ ...baseProps, type: 'plusclean' });
