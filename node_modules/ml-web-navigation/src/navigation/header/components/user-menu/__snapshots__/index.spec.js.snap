...
exports[`Mercado Libre Navigation User Menu Component matches the default snapshot for user menu, in desktop and guest user 1`] = `
<React.Fragment>
  <SideEffect(Style)
    critical={false}
...
exports[`Mercado Libre Navigation User Menu Component matches the default snapshot for user menu, in desktop and logged in user 1`] = `
<React.Fragment>
  <SideEffect(Style)
    critical={false}
    firstRequestInlineStyles={null}
...
exports[`Mercado Libre Navigation User Menu Component matches the default snapshot for user menu, in mobile and guest user 1`] = `
<React.Fragment>
  <SideEffect(Style)
    critical={false}
    firstRequestInlineStyles={null}
...
exports[`Mercado Libre Navigation User Menu Component matches the default snapshot for user menu, in mobile and logged in user 1`] = `
<React.Fragment>
  <SideEffect(Style)
    critical={false}
    firstRequestInlineStyles={null}
