...
describe('Mercado Libre Navigation', () => {
  describe('Guest User Menu props', () => {
    it('returns props needed for the Guest User Menu Component', () => {
      ...
      expect(props.welcome.login).toEqual(baseProps.urls.login);
      expect(props.welcome.registration).toEqual(baseProps.urls.registration);
      expect(props.userLinksSections).toBeDefined();
    });
  });
});
