...
describe('Mercado Libre Navigation', () => {
  describe('Cart props', () => {
    it('returns props needed for the Cart Component', () => {
      const props = cartProps(baseProps);

      expect(props.cartInfo).toBeDefined();
      expect(props.type).toBeDefined();
      expect(props.url).toEqual(baseProps.urls.cart.link);
      expect(props.title).toEqual(baseProps.urls.cart.name);
      expect(props.show).toEqual(true);
      expect(props.isMobile).toBeDefined();
      expect(props.cdnDomain).toEqual(baseProps.cdn.link);
    });

    it('returns props needed for the Cart Component, with show false since there is no cartInfo', () => {
      const noCartInfoProps = { ...baseProps, cartInfo: null };
      const props = cartProps(noCartInfoProps);
