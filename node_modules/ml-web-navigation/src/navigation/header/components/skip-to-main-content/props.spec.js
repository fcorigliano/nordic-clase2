const skipToMainContentProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('Skip to main content props', () => {
    it('returns props when platform has no translation', () => {
      const props = skipToMainContentProps(baseProps);

      expect(props.mainContent).toEqual(undefined);
      expect(props.text).toEqual('Ir al contenido principal');
    });
  });
});
