...
const footerLinksProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('Footer links props', () => {
    it('returns props needed for the Footer links component', () => {
      const props = footerLinksProps(baseProps);
