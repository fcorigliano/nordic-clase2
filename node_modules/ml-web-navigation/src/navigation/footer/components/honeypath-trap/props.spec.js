const honeypathTrapProps = require('./props');
...
describe('Mercado Libre Navigation', () => {
  describe('HoneypathTrap props', () => {
    it('returns props needed for the HoneypathTrap Component', () => {
      const props = honeypathTrapProps(baseProps);
      expect(props.label).toBeDefined();
      expect(props.label).toEqual('Mercado Libre');
      expect(props.url).toBeDefined();
      expect(props.url).toEqual('https://hp.mercadolibre.com/');
      expect(props.webView).toBeFalsy();
      expect(props.platformId).toBeDefined();
      expect(props.platformId).toEqual('ML');
      expect(props.siteId).toBeDefined();
      expect(props.siteId).toEqual('MLA');
      expect(props.deviceType).toBeDefined();
      expect(props.deviceType).toEqual('mobile');
    });
  });
});
