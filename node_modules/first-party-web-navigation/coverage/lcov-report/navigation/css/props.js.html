...
<head>
    <title>Code coverage report for navigation/css/props.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">navigation/css</a> props.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const {
  ...
  getEnvironment,
  addUpdateHandler,
} = require('first-party-navigation-config');
&nbsp;
const propsMapper = (props) =&gt; {
  const configGetter = <span class="fstat-no" title="function not covered" >({</span>
    key,
    platform,
  }) =&gt; <span class="cstat-no" title="statement not covered" >getValue({</span>
    key,
    req: props.req,
    platform,
  });
...
&nbsp;
  return {
    ...
    firstRequestInlineStyles: !!(props.criticalPath || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.key,
