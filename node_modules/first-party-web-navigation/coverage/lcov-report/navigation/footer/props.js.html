...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const feConfig = require('frontend-config');
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!firstPartyConfig) <span class="cstat-no" title="statement not covered" >return { isDesktop, links: null, texts: null };</span>
&nbsp;
