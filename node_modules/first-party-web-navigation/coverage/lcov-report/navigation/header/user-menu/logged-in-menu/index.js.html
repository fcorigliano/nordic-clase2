...
<head>
    <title>Code coverage report for navigation/header/user-menu/logged-in-menu/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">navigation/header/user-menu/logged-in-menu</a> index.js</h1>
        <div class='clearfix'>
...
&nbsp;
const LoggedInMenu = <span class="fstat-no" title="function not covered" >(p</span>rops) =&gt; {
  const {
    userName,
    links,
    myAccountText,
  } = <span class="cstat-no" title="statement not covered" >props;</span>
  const hasLinks = <span class="cstat-no" title="statement not covered" >links &amp;&amp; !!links.length;</span>
          ...
          &lt;div className={`${namespace}__logged-options`}&gt;
            ...
            &lt;div className={`${namespace}__options`}&gt;
              &lt;div className={`${namespace}__option`}&gt;
                ...
                {
                  links.map(<span class="fstat-no" title="function not covered" >li</span>nk =&gt; (
<span class="cstat-no" title="statement not covered" >                    &lt;a className={`${namespace}__options-link`} href={link.link}&gt;{link.name}&lt;/a&gt;</span>
                  ))
                }
              &lt;/div&gt;
            &lt;/div&gt;
