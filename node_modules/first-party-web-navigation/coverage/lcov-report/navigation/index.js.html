...
<head>
    <title>Code coverage report for navigation/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">navigation</a> index.js</h1>
        <div class='clearfix'>
...
const { isHidden } = require('@frontend-navigations/commons/layout-type-detection');
...
const Navigation = ({ children, ...props }) =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (isHidden(props.type)) {
    return [children];
  }
&nbsp;
