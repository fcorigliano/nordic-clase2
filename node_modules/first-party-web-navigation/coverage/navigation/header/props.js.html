...
<head>
    <title>Code coverage report for navigation/header/props.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">navigation/header</a> props.js</h1>
        <div class='clearfix'>
...
const linkTransformations = {
  login: <span class="fstat-no" title="function not covered" >(l</span>inkData, options) =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
...
const getLinks = (headerLinks, feConfigUrls, fpConfigUrls, options) =&gt; headerLinks.map(link =&gt; {
  ...
  return {
    ...linkConfig, // eslint-disable-line security/detect-object-injection
      ...(linkTransformations[link] &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >linkTransformations[link](linkConfig, options))</span>, // eslint-disable-line
    id: link,
  };
});
&nbsp;
const headerProps = (props) =&gt; {
  ...
  const isDesktop = props.device.desktop || <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
...
&nbsp;
  const logo = {
    ...logoProps(props),
    url: (fpConfigUrls.firstPartyHome) ? fpConfigUrls.firstPartyHome.link : <span class="branch-1 cbranch-no" title="branch not covered" >feConfigUrls.home.link,</span>
  };
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!firstPartyConfig) {
