...
describe('CBT Navigation', () => {
  describe('User Menu Logged In', () => {
    it('matches the default snapshot and returns logged in menu with current site id', () => {
    ...
    it('matches the default snapshot and returns logged in menu without current site id', () => {
      const renderer = new ShallowRenderer();
      const component = (
        <LoggedIn
          {...baseProps}
    ...
    it('matches the default snapshot and returns logged in menu with showSiteSwitcher in false', () => {
      const renderer = new ShallowRenderer();
      const component = (
        <LoggedIn
          {...baseProps}
