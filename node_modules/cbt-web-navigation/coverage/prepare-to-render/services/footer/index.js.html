...
<head>
    <title>Code coverage report for prepare-to-render/services/footer/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">prepare-to-render/services/footer</a> index.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// eslint-disable-next-line import/no-extraneous-dependencies
...
&nbsp;
  const links = getValue({
    ...
    platform,
    req,
  }).map(link =&gt; cbtConfigUrls[link] || <span class="branch-1 cbranch-no" title="branch not covered" >feConfigUrls[link])</span>;
&nbsp;
