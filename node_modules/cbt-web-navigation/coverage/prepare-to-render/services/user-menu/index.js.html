...
<head>
    <title>Code coverage report for prepare-to-render/services/user-menu/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">prepare-to-render/services/user-menu</a> index.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { getValue } = require('cbt-navigation-config');
...
const generateServiceContext = (req) =&gt; {
  ...
  return {
    ...
    cbtInfo: cbt || <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
