...
<head>
    <title>Code coverage report for navigation/header/components/user-menu/logged-in/site-switcher/props.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">navigation/header/components/user-menu/logged-in/site-switcher</a> props.js</h1>
        <div class='clearfix'>
...
<a name='L60'></a><a href='#L60'>60</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const sitePriorities = {
  MLM: 1,
  MLB: 2,
  MLA: 3,
  MLC: 4,
...
&nbsp;
  if (siteAPriority) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (siteBPriority) {
