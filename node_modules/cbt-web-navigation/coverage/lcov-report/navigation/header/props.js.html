...
const headerProps = (props) =&gt; {
  ...
  const showLoggedInLinks = isLoggedIn &amp;&amp; (props.userMenu.loggedLinks.length &gt; 0 || <span class="branch-2 cbranch-no" title="branch not covered" >props.userMenu.icons.length &gt; 0)</span>;
&nbsp;
  return {
