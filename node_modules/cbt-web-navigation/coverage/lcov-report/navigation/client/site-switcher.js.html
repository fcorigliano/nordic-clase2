...
<head>
    <title>Code coverage report for navigation/client/site-switcher.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">navigation/client</a> site-switcher.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">function siteSwitcher(currentSite) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (document) {
    ...
    el.addEventListener('click', (event) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (newSite &amp;&amp; (newSite !== currentSite)) {
