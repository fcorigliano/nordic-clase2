...
const GuestWelcomeIcon = ({ namespace }) => (
  <div className={`${namespace}-logo`}>
    <svg className={`${namespace}-icon`} width="28" height="35" xmlns="http://www.w3.org/2000/svg">
      <path
...
GuestWelcomeIcon.propTypes = {
  namespace: PropTypes.string.isRequired,
};

module.exports = GuestWelcomeIcon;
