...
describe('Portal Inmobiliario Navigation', () => {
  describe('Footer props', () => {
    it('returns props needed for the Footer Component', () => {
      ...
      expect(props.baseFooter.extraCompanyName).toEqual(null);
    });

    it('returns honeypath props for the Footer Component', () => {
      const props = footerProps(baseProps);
      expect(props.honeypathTrap.siteId).toEqual('MLC');
      expect(props.honeypathTrap.url).toEqual('https://hp.mercadolibre.com/');
    });
  });
});
