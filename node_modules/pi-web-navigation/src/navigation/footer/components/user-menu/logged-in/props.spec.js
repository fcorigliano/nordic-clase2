...
describe('Portal Inmobiliario Navigation', () => {
  ...
  describe('Footer UserMenu Logged in props', () => {
    it('returns props needed for desktop and PII data', () => {
      ...
      expect(result).toEqual({
        lazyLoad: 'off',
        link: baseProps.urls.myAccount.link,
        username: baseProps.navigationPIIData.preferredName,
        ...resultUserPictures,
      });
    ...
    it('returns props needed for non desktop and no PII data', () => {
      ...
      expect(result).toEqual({
        lazyLoad: 'on',
        link: testProps.urls.myAccount.link,
        username: testProps.user.nickname,
        ...resultUserPictures,
      });
