...
var Perfume = /** @class */ (function () {
    ...
    Perfume.prototype.end = function (markName, customProperties, doLogData) {
        ...
        var measure = measure_1.performanceMeasure(markName);
        if (doLogData) {
            log_1.logData(markName, utils_1.roundByFour(measure), customProperties);
        }
    };
    /**
    ...
    Perfume.prototype.markNTBT = function () {
        ...
        ntbtTimeoutID = setTimeout(function () {
            ...
            log_1.logMetric(metrics_1.ntbt.value, "ntbt");
            metrics_1.ntbt.value = 0;
        }, 2000);
    };
    return Perfume;
